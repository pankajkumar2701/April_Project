...
using April_Project.Models;
using April_Project.Data;
using April_Project.Filter;
using April_Project.Entities;
using April_Project.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace April_Project.Controllers
{
    /// <summary>
    ...
    {
        private readonly April_ProjectContext _context;

        public RoleEntitlementController(April_ProjectContext context)
        {
            _context = context;
        }
