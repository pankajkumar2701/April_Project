...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "April_Project", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<April_ProjectContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "April_Project API v1");
